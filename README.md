...
- **Username**: `admin`
- **Password**: `defaultPassword123` (development default)

To override the default password, set the `ADMIN_PASSWORD` environment variable before starting the application:
```bash
